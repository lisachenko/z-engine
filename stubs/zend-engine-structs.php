...
/**
 * Analysis-only view of the engine C struct 'zend_ast_op_array'; the runtime value is always FFI\CData.
 *
 * @internal
 */
final class zend_ast_op_array
{
    public int $kind;
    public int $attr;
    public int $lineno;
...
final class zend_attribute
{
    ...
    public ?zend_string $validation_error;
    public int $flags;
    public int $lineno;
    public int $offset;
    public int $argc;
...
/**
 * Analysis-only view of the engine C struct 'zend_err_buf'; the runtime value is always FFI\CData.
 *
 * @internal
 */
final class zend_err_buf
{
    public int $size;
    public int $capacity;
...
final class zend_executor_globals
{
    ...
    public HashTable $autoload_current_classnames;
...
final class zend_ini_entry
{
    ...
    public ?zend_ini_entry_def $def;

    private function __construct() {}
}

/**
 * Analysis-only view of the engine C struct 'zend_ini_entry_def'; the runtime value is always FFI\CData.
 *
 * @internal
 */
final class zend_ini_entry_def
{
...
final class zend_object_handlers
{
    ...
    public \FFI\CData|\Closure|null $clone_obj_with;
...
final class zend_oparray_context
{
    ...
    public ?zend_string $active_property_info_name;
    public int $active_property_hook_kind;
    public bool $in_jmp_frameless_branch;
    public bool $in_finally;
    public bool $has_assigned_to_http_response_header;
