...
public const NOP                            = 0;
    ...
    public const ARRAY_KEY_EXISTS               = 194;
    ...
    public const FETCH_GLOBALS                  = 200;
    public const VERIFY_NEVER_TYPE              = 201;
    public const CALLABLE_CONVERT               = 202;
    public const BIND_INIT_STATIC_OR_JMP        = 203;
    public const FRAMELESS_ICALL_0              = 204;
    public const FRAMELESS_ICALL_1              = 205;
    public const FRAMELESS_ICALL_2              = 206;
