...
class NodeKind
{
    ...
    /* Generated for PHP 8.4 from enum _zend_ast_kind; EngineConstantsTest guards these values */
    public const int AST_ZVAL                      = 64;
    public const int AST_CONSTANT                  = 65;
    public const int AST_ZNODE                     = 66;
    public const int AST_FUNC_DECL                 = 67;
    public const int AST_CLOSURE                   = 68;
    public const int AST_METHOD                    = 69;
    public const int AST_CLASS                     = 70;
    public const int AST_ARROW_FUNC                = 71;
    public const int AST_PROPERTY_HOOK             = 72;
    ...
    public const int AST_EMPTY                     = 262;
    public const int AST_ISSET                     = 263;
    public const int AST_SILENCE                   = 264;
    public const int AST_SHELL_EXEC                = 265;
    public const int AST_CLONE                     = 266;
    public const int AST_EXIT                      = 267;
    public const int AST_PRINT                     = 268;
    public const int AST_INCLUDE_OR_EVAL           = 269;
    public const int AST_UNARY_OP                  = 270;
    public const int AST_PRE_INC                   = 271;
    public const int AST_PRE_DEC                   = 272;
    public const int AST_POST_INC                  = 273;
    public const int AST_POST_DEC                  = 274;
    public const int AST_YIELD_FROM                = 275;
    public const int AST_CLASS_NAME                = 276;
    public const int AST_GLOBAL                    = 277;
    public const int AST_UNSET                     = 278;
    public const int AST_RETURN                    = 279;
    public const int AST_LABEL                     = 280;
    public const int AST_REF                       = 281;
    public const int AST_HALT_COMPILER             = 282;
    public const int AST_ECHO                      = 283;
    public const int AST_THROW                     = 284;
    public const int AST_GOTO                      = 285;
    public const int AST_BREAK                     = 286;
    public const int AST_CONTINUE                  = 287;
    public const int AST_PROPERTY_HOOK_SHORT_BODY  = 288;
