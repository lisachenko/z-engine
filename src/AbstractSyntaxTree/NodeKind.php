...
class NodeKind
{
    ...
    public const AST_ZNODE                     = 66;
    public const AST_FUNC_DECL                 = 67;
    public const AST_CLOSURE                   = 68;
    public const AST_METHOD                    = 69;
    public const AST_CLASS                     = 70;
    public const AST_ARROW_FUNC                = 71;
    public const AST_PROPERTY_HOOK             = 72;
    ...
    public const AST_SILENCE                   = 264;
    public const AST_SHELL_EXEC                = 265;
    public const AST_CLONE                     = 266;
    public const AST_EXIT                      = 267;
    public const AST_PRINT                     = 268;
    public const AST_INCLUDE_OR_EVAL           = 269;
    public const AST_UNARY_OP                  = 270;
    public const AST_PRE_INC                   = 271;
    public const AST_PRE_DEC                   = 272;
    public const AST_POST_INC                  = 273;
    public const AST_POST_DEC                  = 274;
    public const AST_YIELD_FROM                = 275;
    public const AST_CLASS_NAME                = 276;
    public const AST_GLOBAL                    = 277;
    public const AST_UNSET                     = 278;
    public const AST_RETURN                    = 279;
    public const AST_LABEL                     = 280;
    public const AST_REF                       = 281;
    public const AST_HALT_COMPILER             = 282;
    public const AST_ECHO                      = 283;
    public const AST_THROW                     = 284;
    public const AST_GOTO                      = 285;
    public const AST_BREAK                     = 286;
    public const AST_CONTINUE                  = 287;
    public const AST_PROPERTY_HOOK_SHORT_BODY  = 288;
