...
/*
 * Generated by tools/generator for PHP 8.6 (darwin-arm64-zts, release) - DO NOT EDIT.
...
typedef const struct _zend_op *( *zend_vm_opcode_handler_t)(struct _zend_execute_data *execute_data, const struct _zend_op *opline);
...
extern zend_ast * zend_ast_create_zval_ex(const zval *, zend_ast_attr);
...
extern HashTable * zend_array_dup(const HashTable *);
