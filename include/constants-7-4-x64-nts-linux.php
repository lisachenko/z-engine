...
class Defines
{
	...
	public const ZEND_HAS_STATIC_IN_METHODS = 65536;
	public const ZEND_ACC_REUSE_GET_ITERATOR = 262144;
	public const ZEND_ACC_RESOLVED_PARENT = 524288;
	public const ZEND_ACC_RESOLVED_INTERFACES = 1048576;
	public const ZEND_ACC_UNRESOLVED_VARIANCE = 2097152;
	...
	public const ZEND_ACC_CLOSURE = 1048576;
	public const ZEND_ACC_FAKE_CLOSURE = 2097152;
	public const ZEND_ACC_HEAP_RT_CACHE = 4194304;
	public const ZEND_ACC_USER_ARG_INFO = 4194304;
	...
	public const ZEND_ACC_TRAIT_CLONE = 134217728;
	public const ZEND_ACC_CTOR = 268435456;
	...
	public const GC_COLLECTABLE = 16;
...
class _zend_ast_kind
{
	...
	public const ZEND_AST_STATIC_PROP = 514;
	public const ZEND_AST_CALL = 515;
	public const ZEND_AST_CLASS_CONST = 516;
	public const ZEND_AST_ASSIGN = 517;
	public const ZEND_AST_ASSIGN_REF = 518;
	public const ZEND_AST_ASSIGN_OP = 519;
	public const ZEND_AST_BINARY_OP = 520;
	public const ZEND_AST_GREATER = 521;
	public const ZEND_AST_GREATER_EQUAL = 522;
	public const ZEND_AST_AND = 523;
	public const ZEND_AST_OR = 524;
	public const ZEND_AST_ARRAY_ELEM = 525;
	public const ZEND_AST_NEW = 526;
	public const ZEND_AST_INSTANCEOF = 527;
	public const ZEND_AST_YIELD = 528;
	public const ZEND_AST_COALESCE = 529;
	public const ZEND_AST_ASSIGN_COALESCE = 530;
	public const ZEND_AST_STATIC = 531;
	public const ZEND_AST_WHILE = 532;
	public const ZEND_AST_DO_WHILE = 533;
	public const ZEND_AST_IF_ELEM = 534;
	public const ZEND_AST_SWITCH = 535;
	public const ZEND_AST_SWITCH_CASE = 536;
	public const ZEND_AST_DECLARE = 537;
	public const ZEND_AST_USE_TRAIT = 538;
	public const ZEND_AST_TRAIT_PRECEDENCE = 539;
	public const ZEND_AST_METHOD_REFERENCE = 540;
	public const ZEND_AST_NAMESPACE = 541;
	public const ZEND_AST_USE_ELEM = 542;
	public const ZEND_AST_TRAIT_ALIAS = 543;
	public const ZEND_AST_GROUP_USE = 544;
	public const ZEND_AST_PROP_GROUP = 545;
	public const ZEND_AST_METHOD_CALL = 768;
	public const ZEND_AST_STATIC_CALL = 769;
	public const ZEND_AST_CONDITIONAL = 770;
	public const ZEND_AST_TRY = 771;
	public const ZEND_AST_CATCH = 772;
	public const ZEND_AST_PARAM = 773;
	public const ZEND_AST_PROP_ELEM = 774;
	public const ZEND_AST_CONST_ELEM = 775;
